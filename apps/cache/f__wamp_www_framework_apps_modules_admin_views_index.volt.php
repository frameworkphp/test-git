...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <?php echo $this->tag->stylesheetLink('plugins/bootstrap/css/bootstrap.min.css'); ?>

        <!-- Font Awesome -->
        <?php echo $this->tag->stylesheetLink('plugins/font-awesome/css/font-awesome.min.css'); ?>

        <!-- Pace -->
        <?php echo $this->tag->stylesheetLink('css/admin/pace.css'); ?>

        <!-- Color box -->
        <?php echo $this->tag->stylesheetLink('css/admin/colorbox.css'); ?>

        <!-- Morris -->
        <?php echo $this->tag->stylesheetLink('css/admin/morris.css'); ?>

        <!-- Endless -->
        <?php echo $this->tag->stylesheetLink('css/admin/main.css'); ?>
        <?php echo $this->tag->stylesheetLink('css/admin/endless-skin.css'); ?>
    </head>
...
<footer>
    <div class="row">
        ...
        <!-- Jquery -->
        <?php echo $this->tag->javascriptInclude('public/plugins/jquery/jquery-1.10.2.min.js'); ?>

        <!-- Bootstrap -->
        <?php echo $this->tag->javascriptInclude('public/plugins/bootstrap/js/bootstrap.js'); ?>

        <!-- Flot -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.flot.min.js'); ?>

        <!-- Morris -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/rapheal.min.js'); ?>
        <?php echo $this->tag->javascriptInclude('public/js/admin/morris.min.js'); ?>

        <!-- Colorbox -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.colorbox.min.js'); ?>

        <!-- Sparkline -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.sparkline.min.js'); ?>

        <!-- Pace -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/pace.js'); ?>

        <!-- Popup Overlay -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.popupoverlay.min.js'); ?>

        <!-- Slimscroll -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.slimscroll.min.js'); ?>

        <!-- Modernizr -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/modernizr.min.js'); ?>

        <!-- Cookie -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/jquery.cookie.min.js'); ?>

        <!-- Endless -->
        <?php echo $this->tag->javascriptInclude('public/js/admin/endless_dashboard.js'); ?>
        <?php echo $this->tag->javascriptInclude('public/js/admin/main.js'); ?>
        <?php echo $this->tag->javascriptInclude('public/js/admin/parsley.min.js'); ?>
    </body>
</html>
