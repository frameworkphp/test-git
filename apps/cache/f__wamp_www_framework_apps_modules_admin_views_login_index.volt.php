...
<head>
    ...
    <?php echo $this->tag->stylesheetLink('plugins/font-awesome/css/font-awesome.css'); ?>
    <?php echo $this->tag->stylesheetLink('css/admin/endless.min.css'); ?>
</head>
            ...
            <div class="panel-body">
                ...
                <form id="formValidate1" action="" method="post" class="form-login" data-parsley-validate>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text" placeholder="Email" name="femail" value="<?php echo $formData['femail']; ?>"
